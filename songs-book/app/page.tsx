...
export default async function HomePage() {
  ...
  const categories = [
    { title: "Songs of Praise", href: "/all", icon: <Music size={22}/>, color: "from-blue-500 to-indigo-600" },
    { title: "Alphabet of Praise", href: "/alphabet", icon: <ListOrdered size={22}/>, color: "from-sky-500 to-blue-600" },
    { title: "Themes of Praise", href: "/type", icon: <Layers size={22}/>, color: "from-pink-500 to-rose-600" },
    { title: "Chosen Hymns", href: "/collections", icon: <Bookmark size={22}/>, color: "from-orange-500 to-amber-600" }
  ]
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-24">
        ...
        {/* Search — client component with songs passed as props */}
